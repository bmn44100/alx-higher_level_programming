...
class Rectangle(Base):
    ...
    @property
    def width(self):
        """ finds Rectangle width """
        return self.__width

    @property
    def height(self):
        """ finds Rectangle height """
        return self.__height

    @property
    def x(self):
        """ finds value x for Rectangle """
        return self.__x

    @property
    def y(self):
        """ finds value y for Rectangle"""
        return self.__y
